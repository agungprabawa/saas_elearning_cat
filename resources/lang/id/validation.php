...
return [
    ...
    */
    ...
    'after_or_equal'  => 'Waktu selesai harus berisi tanggal setelah atau sama dengan waktu mulai.',
    ...
    */
    ...
    'attributes' => [
        'attr-1' => 'E-Learning',
        'attr-2' => 'Assisted Test',
        'attr-3' => 'Kapasitas user',
        'attr-4' => 'Kapasitas penyimpanan',

        // taribut page profil
        'profile_avatar' => 'Foto Profil',
        'name' => 'Nama',
        'username' => 'Username',
        'bio' => 'Deskripsi',
        ...
        're_password' => 'Konfirmasi Password Baru',
        ...
        'ctitle' => 'Judul / Topik',
        'cdesc' => 'Deskripsi',
        'filepath' => 'Gambar Cover',
        'max_time' => 'Maksimal Waktu Pengerjaan',
        'max_user' => 'Kapasitas User',
        'start_date' => 'Waktu Mulai',
        'end_date' => 'Waktu Selesai',
        'course_price' => 'Harga',

        'company_name' => 'Nama Lembaga',
        'company_type' => 'Jenis Lembaga',
        ...
        'selected_users' => 'Pilihan partisipan',
        'selected_elearning' => 'Pilihan elearning',
        'selected_assistedtest' => 'Pilihan assisted test',

        'type' => 'Tipe',

        'elearning' => 'E-learning',
        'assistedtest' => 'Assisted Test',
        ...
        'task_file' => 'Berkas jawaban',
        'task_answer' => 'Jawaban langsung',

        'send_to_elearning' => 'Pilihan kursus',
        'send_to_assistedtest' => 'Pilihan ujian',
        'send_to_all' => 'Kirim ke semua',
        'send_to_role' => 'Pilihan tipe user'
    ],
];
