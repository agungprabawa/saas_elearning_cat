		...
		<div class="kt-header__brand " id="kt_header_brand">
			<div class="kt-header__brand-logo">
				<a href="">
					...
					<img style="max-height:55px !important" src="" alt="Sudo" srcset="">
				</a>
			</div>
		...
		<div class="kt-header__topbar">
            <div class="kt-header__topbar-item">
                ...
                <div class="dropdown" style="margin: auto 0; vertical-align: middle;">
                    <button type="button" class="btn btn-default" data-toggle="" aria-haspopup="true" aria-expanded="true">
						<?php
							$managed_name = '';
							if(isset($managed['company'])){
								$managed_name = ' - '.$managed['company']->company_name;
							}
						?>
                        Super Admin {{ $managed_name }}
                    </button>
				...
				<div class="dropdown-menu dropdown-menu-fit dropdown-menu-right dropdown-menu-anim dropdown-menu-xl">
					...
					<div class="kt-user-card kt-user-card--skin-light kt-notification-item-padding-x">
						...
						<div class="kt-user-card__badge">
							<span class="btn btn-label-primary btn-sm btn-bold btn-font-md">Saldo Rp. 2.000.000</span>
						</div>
						@endif --}}
					</div>
