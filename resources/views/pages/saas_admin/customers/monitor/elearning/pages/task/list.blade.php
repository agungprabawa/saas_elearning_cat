...
<script>
    ...
    let run_kt_table = $(kt_table).DataTable({
        ...
        processing: true,
        serverSide: true,
        ajax: '{{ route("sudo.customers.monitor.data.courses.task.list",["$id_company","$courses->id_courses"]) }}',
        columns: [{
        ...
        columnDefs: [
            ...
            },
            {
                ...
                render: (data, type, row)=>{
                    ...
                    <a href="#" class="btn_del_task btn btn-warning" data-id="${data}" data-id-company="${row['id_company']}" data-id-courses="${row['id_courses']}" >Hapus</a>`;
    ...
    $(kt_table).on('click','.btn_del_task', function (e) {
        e.preventDefault();
        let data_id = $(this).attr('data-id');
        let id_company = $(this).attr('data-id-company');
        let id_courses = $(this).attr('data-id-courses');
        let remove_link = "{{ route('sudo.customers.monitor.courses.task.delete',[':id_company',':id_courses']) }}";
            ...
            if (result.value) {
                ...
                ajax_req.done(function (response) {
                    ...
                    swal.fire({
                        ...
                        type: 'success',
                        html: 'Tugas pada kursus ini berhasil dihapus',
                        confirmButtonClass: 'btn btn-primary',
