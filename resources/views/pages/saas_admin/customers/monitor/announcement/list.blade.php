                    ...
                    <div class="kt-portlet__head">
                        <div class="kt-portlet__head-label">
                            <h3 class="kt-portlet__head-title">
                                Daftar Pengumuman Pengguna Layanan
                            </h3>
                        </div>
                    </div>
                    <div class="kt-portlet__body">
                        <table class="table table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
                            ...
                            <tr>
                                ...
                                <th style="width: 40%">Sekilas Isi</th>
                                <th style="width: auto">Pembuat</th>
                                <th style="width: auto">Dibuat Pada</th>
...
@section('script-bottom')
    ...
    <script>
        ...
        $('#kt_table_1').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: '{{ route("sudo.customers.monitor.data.announ.list","$id_company") }}',
            columns: [
                {
            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    render: (data, type, row)=>{
                        let btn_html =
                            `<a href="{{ route('sudo.customers.monitor.announ.details',[':id_company',':id_announ']) }}" class="">Lihat Detail</a>`;

                        btn_html = btn_html.replace(":id_announ", data).replace(':id_company',row['id_company']);
