...
<script>
    ...
    $('#kt_table_1').DataTable({
        ...
        processing: true,
        serverSide: true,
        ajax: '{{ route("sudo.customers.monitor.data.exams.list","$id_company") }}',
        columns: [{
        ...
        columnDefs: [
            ...
            },
            {
                ...
                render: (data, type, row)=>{
                    var btn_html = `<a href="{{ route('sudo.customers.monitor.exam.details',[':id_company',':id_exam']) }}">Lihat Detail</a>`;
                    // console.log(row);

                    btn_html = btn_html.replace(":id_exam", data).replace(':id_company',row['id_company']);
