        ...
        <div class="kt-portlet__body kt-portlet__body--fit">
            ...
            <div class="kt-invoice-2">
                            ...
                            <table class="table">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="text-transform: uppercase">@lang('payment.tb-due-date')</th>
                                        <th></th>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @if($company->subscribe_until != NULL)
                                                {{ $dueDate }}
                                            @else
                                                Segera, <strong>Pembayaran Pertama</strong>
                                            @endif
                ...
                <div class="kt-invoice__actions">
                    ...
                    <a href="{{ route('srv_admin.payment.create') }}"  class="btn btn-brand btn-bold" >@lang('payment.btn-pay')</a>
                    </div>
                </div>
            </div>
