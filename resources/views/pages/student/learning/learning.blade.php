        ...
        <div class="kt-subheader__main">
            ...
            <div class="kt-subheader__breadcrumbs">
                ...
                <a href="" class="kt-subheader__breadcrumbs-link">
                    {{ $courses->total() }} Kursus </a>
                <span class="kt-subheader__breadcrumbs-separator"></span>
                @if(isset($_GET['title']))
                Untuk pencarian: &nbsp; <strong>{{ $_GET['title'] ?? '' }}</strong>
                @endif
                <form action="{{ route('student.learning.all.learning') }}" method="GET" class="kt-margin-l-20" id="kt_subheader_search_form">
                ...
                <div class="kt-portlet kt-portlet--height-fluid kt-widget19">
                    <div class="kt-portlet__body kt-portlet__body--fit kt-portlet__body--unfill">
                        ...
                        <div class="kt-widget19__pic kt-portlet-fit--top kt-portlet-fit--sides" style="min-height: 300px; background-image: url('{{ $img_url }}')">
                            ...
                            <div class="kt-widget19__labels">
                                <a href="?category={{ $item->categorys->category ?? 'Tanpa Kategori' }}" class="btn btn-label-light-o2 btn-bold " style="background-color: rgba(79, 79, 79, 0.5) !important; cursor: pointer !important">{{ $item->categorys->category ?? 'Tanpa Kategori' }}</a>
                            </div>
                        </div>
                    </div>
                    <div class="kt-portlet__body">
                        ...
                        <div class="kt-widget19__action">
                            <a href="{{ route('student.learning.learning',[$item->uuid]) }}" style="width:100%" class="btn btn-sm btn-success btn-bold">@lang('courses.stdn-learning-learn-btn')</a>
                        </div>
                    </div>
                </div>
