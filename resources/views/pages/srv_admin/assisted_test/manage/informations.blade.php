            ...
            <div class="kt-portlet" id="form-wrapper">
                <div class="kt-portlet__head">
                    <div class="kt-portlet__head-label">
                        <h3 class="kt-portlet__head-title">@lang('assisted_test.tab-1') <small>@lang('assisted_test.tab-1-sub-up')</small></h3>
                    </div>
                        ...
                        <div class="kt-section kt-section--first">
                            <div class="kt-section__body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="ctitle" value="{{ $exam->title }}">
                                    ...
                                    <div class="col-xl-6">
                                        <div class="form-group">
                                            ...
                                            <select id="categorys" type="text" class="form-control" name="ccategory">
                                                <option {{ ($exam->category == 0) ? 'selected':'' }} value="0">@lang('assisted_test.str-select-0')</option>
                                                @foreach ($examCategory as $item)
                                                <option {{ ($exam->category == $item->id_category ) ? 'selected':'' }} value="{{ $item->id_category }}">{{ $item->category }}</option>
                                                @endforeach
                                            </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea type="text" name="cdesc" id="editor1">{!! $exam->descriptions !!}</textarea>
                                    ...
                                    <div class="col-xl-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input id="thumbnail" class="form-control" type="text" value="{{ $exam->cover_img_url }}" name="filepath">
...
<script>
    ...
    btn.on('click', function(e) {
        ...
        var update_url = '{{ route("srv_admin.assistedtest.edit1.update",":uuid") }}';
