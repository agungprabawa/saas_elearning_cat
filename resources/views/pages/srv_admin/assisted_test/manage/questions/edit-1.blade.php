                        ...
                        <div class="kt-section kt-section--first">
                            <div class="kt-section__body">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea type="text" name="question_text" id="editor1">{{ $question->question }}</textarea>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input value="{{ $question->score }}" type="number" name="q_score" min="1" class="form-control">
                                            <div class="invalid-feedback" style="display:block; font-size:14px"></div>
                                ...
                                @foreach ($qOptions as $item)
                                <div class="row">
                                    <div class="col-md-1">
                                        <div class="kt-radio-inline">
                                            <label class="kt-radio">
                                                <input type="hidden" name="randkey[]" value="{{ $item->randkeys }}">
                                                <input type="radio" value="{{ $item->randkeys }}" name="answer"
                                                {{ ($item->randkeys == $question->answer) ? 'checked':'' }}>
                                                <span></span>
                                            </label>
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            <textarea type="text" name="optiontext[]" class="form-control" id="">{{ $item->optiontext }}</textarea>
