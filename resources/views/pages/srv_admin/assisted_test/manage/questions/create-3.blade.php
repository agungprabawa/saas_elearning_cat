                                        ...
                                        <ul class="kt-nav">
                                            ...
                                            <li class="kt-nav__item">
                                                <a href="?type=2" class="kt-nav__link">
                                                    ...
                                                    <span
                                                        class="kt-nav__link-text">@lang('assisted_test.btn-quest-2')</span>
                                                </a>
                                            </li>
                            ...
                            <div class="kt-section kt-section--first">
                                <div class="kt-section__body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea type="text" name="answer" id="editor2"></textarea>
                                        <div class="invalid-feedback" style="display:block; font-size:14px"></div>
                                        <span
                ...
                success: function (response) {
                    ...
                    if ($.isEmptyObject(response.error)) {
                        ...
                        if (btn_type == 'btn_submit') {
                            var url_reload = "{{ route('srv_admin.assistedtest.questions.create',$exam->uuid).'?type=3' }}";
