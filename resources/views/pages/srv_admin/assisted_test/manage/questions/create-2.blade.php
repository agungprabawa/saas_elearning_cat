        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="kt-portlet" id="form-wrapper">
                                        ...
                                        <ul class="kt-nav">
                                            ...
                                            <li class="kt-nav__item">
                                                <a href="?" class="kt-nav__link">
                                                    ...
                                                    <span
                                                        class="kt-nav__link-text">@lang('assisted_test.btn-quest-1')</span>
                                                </a>
                                            </li>
                                            <li class="kt-nav__item">
                                                <a href="?type=3" class="kt-nav__link">
                                                    ...
                                                    <span
                                                        class="kt-nav__link-text">@lang('assisted_test.btn-quest-3')</span>
                                                </a>
                                            </li>
                    ...
                    <form class="kt-form " action="{{ route('srv_admin.assistedtest.questions.store',$exam->uuid) }}"
                          id="kt_form">
                        ...
                        <div class="kt-portlet__body kt-wizard-v4__content">
                            <div class="kt-section kt-section--first">
                                <div class="kt-section__body">
                                    ...
                                    <label>@lang('assisted_test.qtn-c-f3')</label>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input value="1" type="number" name="q_score" min="1"
                                                       class="form-control">
                                    ...
                                    <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
                                        ...
                                        <div class="btn-group" role="group">
                                            <button id="btnGroupDrop1" type="button"
                                                    class="btn btn-secondary dropdown-toggle rmaftermargin"
                                                    data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                            </button>
                                            <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                                <button class="btn_selector dropdown-item"
                                                        id="btn_submit_done">@lang('general.btn-save-done')</button>

                                            </div>
                                        </div>
                                        <button id="btn_submit" type="button"
                                                class="btn_selector btn btn-success">@lang('general.btn-save-add')</button>
                                    </div>
                                </div>
                ...
                success: function (response) {
                    ...
                    if ($.isEmptyObject(response.error)) {
                        ...
                        if (btn_type == 'btn_submit') {
                            var url_reload = "{{ route('srv_admin.assistedtest.questions.create',$exam->uuid).'?type=2' }}";
