                                ...
                                <div class="kt-widget__bottom" style="margin-bottom:2rem">
                                    <div class="kt-widget__item">
                                        ...
                                        <div class="kt-widget__details">
                                            <span class="kt-widget__title">Skor akhir</span>
                                            <span class="kt-widget__value">{{ $user->final_result ?? '-' }}</span>
                                        </div>
                                    </div>
                                    <div class="kt-widget__item">
                                        <?php 
                                            if(empty($user->exam_end)){
                                                $longTime = 0;
                                            }else{
                                                $longTime = \Carbon\Carbon::parse($user->exam_start)->diffInMinutes($user->exam_end);
                                            }
                                        ...
                                        <div class="kt-widget__details">
                                            <span class="kt-widget__title">Lama pengerjaan</span>
                                            <span class="kt-widget__value">{{ hoursandmins($longTime) }}</span>
                                        </div>
                                    </div>
                                    <div class="kt-widget__item">
                                        <div class="kt-widget__icon">
                                        ...
                                        <div class="kt-widget__details">
                                            <span class="kt-widget__title">Dikerjakan pada</span>
                                            <span class="kt-widget__value">{{ formatDateTime($user->exam_start) }}</span>
                                        </div>
                                    </div>
...
<script>
    ...
    btn_finish.click(function() {
        ...
        let update_url = "{{ route('srv_admin.assistedtest.result.update',$exam->uuid) }}?id={{ $user->id_participant }}";
