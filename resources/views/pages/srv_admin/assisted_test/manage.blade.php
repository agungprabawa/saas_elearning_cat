    ...
    <div class="kt-container  kt-container--fluid ">
        <div class="kt-subheader__main">
            <h3 class="kt-subheader__title">
                @lang('assisted_test.mng-title') </h3>
            ...
            <div class="kt-subheader__breadcrumbs">
                ...
                @endif
                <form action="{{ route('srv_admin.assistedtest.show') }}" method="GET" class="kt-margin-l-20" id="">
                    ...
                    <div class="kt-portlet__body kt-portlet__body--fit kt-portlet__body--unfill">
                        <?php
                            ...
                            if($item->is_no_end_time){
                                $end_date = \Lang::get('assisted_test.pb-c-i-noend-date-1');
                                $end_time = '';
                            }
                        ?>
                        <div class="kt-widget19__pic kt-portlet-fit--top kt-portlet-fit--sides" style="min-height: 300px; background-image: url('{{ $img_url }}')">
                            ...
                            <div class="kt-widget19__labels">
                                <a href="#" class="btn btn-label-light-o2 btn-bold ">{{ $item->categorys->category ?? 'Tanpa Kategori' }}</a>
                            </div>
                        </div>
                    </div>
                    <div class="kt-portlet__body">
                        <div class="kt-widget19__wrapper">
                            <div class="kt-widget19__content">
                                ...
                                <div class="kt-widget19__stats">
                                    ...
                                    <a href="#" class="kt-widget19__comment">
                                        @lang('assisted_test.pb-c-i-participant')
                                    </a>
                                </div>
                            </div>
                            ...
                            <div class="kt-widget__body">
                                ...
                                <div class="kt-widget__stats kt-margin-t-20" style="display:none !important; justify-content: space-between;">
                                    <div class="kt-widget__item d-flex align-items-center kt-margin-r-30">
                                        <span class="kt-widget__date kt-padding-0 kt-margin-r-10">
                                            @lang('assisted_test.mng-max-time')
                                        </span>
                                        <div class="kt-widget__label">
                                            <span class="btn btn-label-brand btn-sm btn-bold btn-upper"></span>
                                        </div>
                                    </div>
                                    <div class="kt-widget__item d-flex align-items-center kt-padding-l-0">
                                        <span class="kt-widget__date kt-padding-0 kt-margin-r-10 ">
                                        ...
                                        <div class="kt-widget__label">
                                            <span class="btn btn-label-danger btn-sm btn-bold btn-upper">{{ $item->max_time }} Menit</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="kt-widget19__action">
                            <a style="width:100%" href="{{ route('srv_admin.assistedtest.overview',[$item->uuid]) }}" class="btn btn-sm btn-brand btn-bold">@lang('assisted_test.pb-c-i-btn-manage')</a>
                        </div>
                    </div>
                </div>
