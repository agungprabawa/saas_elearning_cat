            ...
            <div class="kt-portlet kt-portlet--mobile">
                ...
                <div class="kt-portlet__body">
                            ...
                            <div class="form-group">
                                <div class="kt-checkbox-list">
                                    <label class="kt-checkbox">
                                        <input name="send_to_all" checked type="checkbox"> Semua User
                                        <span></span>
                                    </label>
                                    <div id="err_send_to_all" class="invalid-feedback" style="display:block; font-size:14px"></div>
                                    <label class="kt-checkbox">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <div class="kt-checkbox-list">
                                        ...
                                        <div id="err_send_to_elearning" class="invalid-feedback" style="display:block; font-size:14px"></div>
                                        <label class="kt-checkbox">
                                            <input name="send_to_assistedtest" type="checkbox"> User Assisted Test
                                            <span></span>
                                        </label>
                                        <div id="err_send_to_assistedtest" class="invalid-feedback" style="display:block; font-size:14px"></div>
                                    </div>
                                    {{-- <span class="form-text text-muted">Some help text goes here</span> --}}
                                </div>
                            </div>
                    ...
                    <div style="display:none" id="c_learning" class="form-group row">
                        ...
                        <div id="err_selected_elearning" class="invalid-feedback" style="display:block; font-size:14px"></div>
                    </div>
                ...
                <div class="kt-portlet__foot" style="float:right">
                    <div class="kt-form__actions">
                        <div class="row justify-content-end">
                            <button id="btn_submit" class="btn btn-success float-left">Umumkan</button>&nbsp;
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    ...
    btn_submit.click(function(e){
        ...
        $.ajax({
            url: '{{ route("srv_admin.announcement.send") }}',
            method: 'post',
