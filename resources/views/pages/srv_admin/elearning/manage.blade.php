        ...
        <div class="kt-subheader__main">
            ...
            <div class="kt-subheader__breadcrumbs">
                ...
                <a href="" class="kt-subheader__breadcrumbs-link">
                    {{ $courses->total() }} @lang('courses.courses') </a>
                <span class="kt-subheader__breadcrumbs-separator"></span>
                @if(isset($_GET['title']))
                Untuk pencarian: &nbsp; <strong>{{ $_GET['title'] ?? '' }}</strong>
                @endif
                <form action="{{ route('srv_admin.courses.show') }}" method="GET" class="kt-margin-l-20" id="kt_subheader_search_form">
                    <div class="kt-input-icon kt-input-icon--right kt-subheader__search">
                        <input name="title" type="text" class="form-control" placeholder="Search..." id="generalSearch">
            ...
            <div class="col-xl-4">
                ...
                <div class="kt-portlet kt-portlet--height-fluid kt-widget19">
                    <div class="kt-portlet__body kt-portlet__body--fit kt-portlet__body--unfill">
                        ...
                        ?>
                        <div class="kt-widget19__pic kt-portlet-fit--top kt-portlet-fit--sides" style="min-height: 300px; background-image: url('{{ $img_url }}'); background-position: center !important;">
                            <h3 class="kt-widget19__title kt-font-light">
                                {{ $item->title }}
                            </h3>
                            <div class="kt-widget19__shadow"></div>
                            <div class="kt-widget19__labels">
                                <a href="#" class="btn btn-label-light-o2 btn-bold " style="background-color: rgba(79, 79, 79, 0.5) !important;">{{ $item->categorys->category ?? 'Tanpa Kategori' }}</a>
                            </div>
                        </div>
                    </div>
                    <div class="kt-portlet__body">
                        <div class="kt-widget19__wrapper">
                            <div class="kt-widget19__content">
                                <div class="kt-widget19__userpic">
                                    <img src="{{ $item->creator->cover_img }}" alt="">
                                </div>
                        ...
                        <div class="kt-widget19__action">
                            <a style="width:100%" href="{{ route('srv_admin.courses.manage',[$item->uuid]) }}" class="btn btn-sm btn-brand btn-bold">@lang('courses.pb-c-i-btn-manage')</a>
                        </div>
                    </div>
                </div>
