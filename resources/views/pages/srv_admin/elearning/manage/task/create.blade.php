                                ...
                                <div class="row" id="fm_start_time">
                                    <div class="col-xl-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group date">
                                                <input readonly value="{{ \Carbon\Carbon::now() }}" name="start_date" type="text" class="form-control" id="start_date" />
                                    ...
                                    <div class="col-xl-6">
                                        <div class="form-group">
                                            ...
                                            <input name="is_no_end_time" checked data-switch="true" type="checkbox" data-on-text="Ya" data-handle-width="70" data-off-text="Tidak" data-on-color="success" value="1" class="form-control">
                                ...
                                <div class="row" id="fm_end_time" style="display:none">
                                    <div class="col-xl-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group date">
                                                <input readonly value="" type="text" name="end_date" class="form-control" id="end_date" />
                                                <div class="input-group-append">
                                                    <span class="input-group-text">
                                                        <i class="la la-calendar glyphicon-th"></i>
                                                    </span>
                                ...
                                <div class="row" style="align-items: center;">
                                    <div class="col-xl-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="number" name="max_submit" min="0" value="1" id="">
...
<script>
    ...
    btn.on('click', function(e) {
        ...
        var update_url = '{{ route("srv_admin.courses.task.store",":uuid") }}';
