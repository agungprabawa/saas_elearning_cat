        ...
        <div class="kt-subheader__main">
            ...
            <div class="kt-subheader__breadcrumbs">
                ...
                <a href="" class="kt-subheader__breadcrumbs-link">
                    {{ $announcement->total() }} Pengumuman </a>
                <span class="kt-subheader__breadcrumbs-separator"></span>
                @if(isset($_GET['title']))
                Untuk pencarian: &nbsp; <strong>{{ $_GET['title'] ?? '' }}</strong>
                @endif
                <form action="{{ route('general.announcement.all') }}" method="GET" class="kt-margin-l-20" id="kt_subheader_search_form">
...
<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
                ...
                <div class="kt-portlet kt-portlet--height-fluid kt-widget19">
                    ...
                    <div class="kt-portlet__body">
                        ...
                        <div class="kt-widget19__action">
                            <a href="{{ route('general.announcement.read',$item->uuid) }}" style="width:100%" class="btn btn-sm btn-success btn-bold">Selengkapnya</a>
                        </div>
                    </div>
                </div>
    ...
    <div class="row">
        <div class="col-md-12">
            {{ $announcement->links('pagination::default') }}
        </div>
