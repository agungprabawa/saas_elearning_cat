...
use App\Http\Controllers\SrvAdmin\FileController;
        ...
        if ($validateData->passes()) {
            $courses = DB::transaction(function () use ($request, $my) {
                ...
                if ($request->courses_cover) {
                    $file_controller = new FileController($my);
                    $fileUrl = $file_controller->cover_img_store($request->courses_cover, $request);
                }
