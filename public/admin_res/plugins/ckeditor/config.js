CKEDITOR.editorConfig = function( config ) {
	...
	config.removeButtons = 'Source,Save,NewPage,Preview,Print,Templates,Cut,Copy,Paste,PasteText,PasteFromWord,Find,SelectAll,Scayt,Form,Radio,TextField,Textarea,Select,Button,ImageButton,HiddenField,Replace,Strike,Subscript,Superscript,CopyFormatting,RemoveFormat,CreateDiv,Language,Anchor,Flash,SpecialChar,PageBreak,ShowBlocks,About,Font,Checkbox,Undo,Redo,Unlink,BidiRtl,BidiLtr,Underline,Styles';
